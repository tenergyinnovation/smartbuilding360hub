 ...
 *                   รีเลย์จะทำงานเมื่ออุณหภูมิสูงกว่าค่าที่กำหนด
...
#define EEPROM_SIZE 64 // ขนาด EEPROM ที่ใช้ (64 bytes)
...
{
    float value = 30.0;
    EEPROM.get(EEPROM_ADDR_TEMP_ALERT, value); // อ่านค่า float จาก EEPROM
