/***********************************************************************
 * Project      :     smartbuilding360hub Water Leak Sensor OLED + Alert
...
{
    Serial.printf("\r\n***********************************************************************\r\n");
    Serial.printf("* Project      :     smartbuilding360hub Water Leak Sensor OLED + Alert\r\n");
...
void loop()
{
    ...
    // แสดงสถานะเซนเซอร์น้ำรั่วทั้งบน Serial และ OLED
