/***********************************************************************
 * Project      :     smartbuilding360hub Vibration Sensor (serial-plotter demo)
...
{
    Serial.printf("\r\n***********************************************************************\r\n");
    Serial.printf("* Project      :     smartbuilding360hub Vibration Sensor (serial-plotter demo)\r\n");
...
void loop()
{
    ...
    {
        snprintf(line1, sizeof(line1), "Vib! Raw:%d", raw);
        snprintf(line2, sizeof(line2), "V:%.2f T:%d", voltage, threshold);
        mcu.displayOLEDLines(line1, line2);
        mcu.beep(2, 200);
    }
    else
    {
        snprintf(line1, sizeof(line1), "Raw:%d V:%.2f", raw, voltage);
