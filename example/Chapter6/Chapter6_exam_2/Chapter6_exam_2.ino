/***********************************************************************
 * Project      :     smartbuilding360hub Motion Sensor 30seconds
...
{
    Serial.printf("\r\n***********************************************************************\r\n");
    Serial.printf("* Project      :     smartbuilding360hub Motion Sensor 30seconds\r\n");
...
void setup()
{
    ...
    mcu.displayOLEDLines("PIR: Ready", "Relay: OFF");
}
...
void loop()
{
    ...
    if (pirState == HIGH) // มีการตรวจจับการเคลื่อนไหว
    {
        ...
        snprintf(line2, sizeof(line2), "Relay: ON");
